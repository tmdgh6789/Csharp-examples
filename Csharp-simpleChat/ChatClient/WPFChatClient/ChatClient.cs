...
namespace WPFChatClient
{
    public class ChatClient
    {
        ...
        public ChatClient(MainWindow mw)
        {
...
            m_fnReceiveHandler = new AsyncCallback(handleDataReceive);
        ...
        public void ConnectToServer(String hostName, UInt16 hostPort)
        {
            ...
            if (isConnected)
            {
                ...
                mainWindow.msgPrint("연결 성공!");

            }
            else
            {

                mainWindow.msgPrint("연결 실패!");
...
            AsyncObject ao = new AsyncObject(1);
            ...
            {
                mainWindow.msgPrint("전송 중 오류 발생 : " + ex.Message);
            }
        }
        ...
        private void handleDataReceive(IAsyncResult ar)
        {
            ...
            if (recvBytes > 0)
            {
                ...
                // 받은 메세지를 출력
                mainWindow.msgPrint("메세지 받음 : " + Encoding.Unicode.GetString(msgByte));
            }
            ...
            catch (Exception ex)
            {
                ...
                mainWindow.msgPrint("자료 수신 대기 도중 오류 발생! 메세지 : " + ex.Message);
                return;
            }
        }
        private void handleDataSend(IAsyncResult ar)
        {
            ...
            {
                // 예외가 발생하면 예외 정보 출력 후 함수를 종료한다.
                mainWindow.msgPrint("자료 송신 도중 오류 발생! 메세지 : " + ex.Message);
                return;
            }
            ...
            if (sentBytes > 0)
            {
                ...
                mainWindow.msgPrint("메세지 보냄 : " + Encoding.Unicode.GetString(msgByte));
            }
        }
    }
}
